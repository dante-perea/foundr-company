# Foundr · foundr-company

> **Canonical agent rules:** [`.claude/rules.md`](./.claude/rules.md) — read before doing meaningful work.

## What this is

(retrofitted — original description not preserved)

- Production: `https://foundr.company/`
- Lab wildcard: `*.lab.foundr.company`
- Repo: `dante-perea/foundr-company`
...
- `.github/workflows/lab-alias.yml` aliases the preview to `https://<feature-slug>.lab.foundr.company/` via `amondnet/vercel-action`
- Sibling worktree at `/home/dante/projects/foundr-company/<feature-slug>/` is where the agent lives for the lifetime of the feature

Merge the PR → `main` auto-deploys to `https://foundr.company/`. Vercel's Deployment Retention Policy (14 days) prunes old preview deployments. `.github/workflows/lab-gc.yml` (cron 6h) prunes dangling aliases.

## Checkout layout — bare-repo colocated

```
/home/dante/projects/foundr-company/
