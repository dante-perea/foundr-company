// Static loading skeleton — paired with /sign-in/loading.tsx so both auth
// surfaces have the same instant-feedback treatment during navigation.
// Mirrors the foundr.company AuthSplitLayout shape (blue testimonial panel +
// white form panel) so the skeleton→form swap is visually stable.
    ...
    <main className="grid min-h-screen animate-pulse md:grid-cols-2">
      ...
      <div className="flex flex-col items-center justify-center bg-white px-6 py-12">
        <div className="w-full max-w-[340px]">
          ...
          <div className="h-7 w-3/5 rounded bg-[#e2e8f0]" aria-hidden="true" />
          <div className="mt-2 h-4 w-2/3 rounded bg-[#eef2f6]" aria-hidden="true" />
